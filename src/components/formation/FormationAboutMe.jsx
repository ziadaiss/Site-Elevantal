...
const FormationAboutMe = () => {
  return <section id="about-me-formation" className="py-16 md:py-24 px-4 sm:px-6 lg:px-8 bg-gray-50">
          ...
          <div className="grid md:grid-cols-12 gap-8 md:gap-12 items-center">
            ...
            <div className="md:col-span-7 text-white text-center md:text-left">
              ...
              <div className="text-gray-200 text-lg space-y-4">
                <p>Moi c’est Ziad, ex-RH passionné par le recrutement. Depuis 4 ans, j’explore ce qui fait vraiment la différence dans une candidature : l’expérience vécue par le candidat et l’image projetée par l’entreprise.</p>
              ...
              <div className="mt-10 pt-6 border-t border-white/20 flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-8 justify-center md:justify-start">
                ...
                <div className="flex items-center space-x-3 justify-center md:justify-start">
                  ...
                  <span className="text-lg md:text-xl font-semibold">+2 RH et recruteurs formés</span>
                </div>
              </div>
...
export default FormationAboutMe;